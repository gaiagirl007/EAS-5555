...
def plot_t(ncfile, name):
    ...
    temp00 = getvar(ncfile, "tc")
    temp12 = getvar(ncfile, "tc", timeidx = 4)
    temp24 = getvar(ncfile, "tc", timeidx = 8)
    temp36 = getvar(ncfile, "tc", timeidx = 12)
    temp48 = getvar(ncfile, "tc", timeidx = 16)
    temps = [temp00, temp12, temp24, temp36, temp48]
...
if __name__ == "__main__":
    ...
    ncfile1 = Dataset("wrfout_d01_2021-04-07_00_00_00")
    ncfile2 = Dataset("wrfout_d01_2021-04-07_00_00_00")
    plot_t(ncfile1, "d1T")
    plot_t(ncfile2, "d2T")
